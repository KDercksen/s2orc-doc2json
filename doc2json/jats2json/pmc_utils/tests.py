...
affiliation_tags_and_parsed_dicts = [
    ...
    (
        """<aff>Department of Internal Medicine, Division of Cardiology, Inha University Hospital, Incheon, South Korea</aff>""",
        None,
    ),
    (
        """<aff id=\"aff1\"><label>1</label>Department of Cardiology, Atatürk Chest Diseases and Chest Surgery Training and Research Hospital; Ankara-Turkey</aff>""",
        None,
    ),
    # there can exist a <label> tag with/without IDs
    (
        """<aff><label>3</label>Center for Medical Education, Sapporo Medical University, <addr-line>Sapporo, Japan</addr-line></aff>""",
        None,
    ),
    ...
    (
        """<aff id=\"I1\">\n<sup>1</sup>Department of Orthodontics, College of Dentistry, King Khalid University, Abha, Saudi Arabia</aff>""",
        None,
    ),
    (
        """<aff id=\"hic312304-aff-0001\"><label><sup>1</sup></label><institution>University of Dundee</institution></aff>""",
        None,
    ),
    # <institution> tags can be straightforward; just ignore and grab text
    (
        """<aff id=\"AF02477-1\"><label>1</label><institution>School of Chemistry, The University of Manchester, Manchester, United Kingdom</institution>""",
        None,
    ),
    # sometimes <institution> tags can have SIBLING tags, like <addr-line> or <country>
    (
        """<aff id=\"aff002\"><label>2</label>Sr. Consultant &amp; Head, Dept. of Neurology, <institution>National Neurosciences Centre, Peerless Hospital</institution>, <addr-line>Kolkata, India</addr-line></aff>""",
        None,
    ),
    (
        """<aff id=\"aff2\"><label><sup>2</sup></label>Institute for Transplantation Diagnostics and Cell Therapeutics, <institution>Heinrich Heine University Düsseldorf</institution>, Düsseldorf, <country>Germany</country>.</aff>""",
        None,
    ),
    ...
    (
        ...
        </institution-wrap>Freising-Weihenstephan, Germany </aff>""",
        None,
    ),
]
